...
# IMPORTANT: Restore TimaticConnector (contains custom methods)
git checkout src/TimaticConnector.php
...
**Note:** You MUST run `git checkout src/TimaticConnector.php` after regeneration to restore custom configuration methods.
